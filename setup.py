...
extras["test_fp8"] = ["torchao"]  # note: TE for now needs to be done via pulling down docker image directly
extras["test_trackers"] = [
    "wandb",
    "comet-ml",
    "tensorboard",
    "dvclive",
    # "mlflow", too many deps that lead to download a very old version of lib
    "matplotlib",
